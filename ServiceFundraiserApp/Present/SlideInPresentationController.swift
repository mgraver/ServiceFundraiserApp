...
//  MedalCount
//
//  Created by Michael Graver on 10/26/17.
...
class SlideInPresentationController: UIPresentationController {
  ...
  override var frameOfPresentedViewInContainerView: CGRect {
    ...
    case .bottom:
      frame.origin.y = containerView!.frame.height*(1.75/3.0)
    default:
      frame.origin = .zero
    }
    return frame
  ...
  override func size(forChildContentContainer container: UIContentContainer,
    ...
    case .bottom, .top:
      return CGSize(width: parentSize.width, height: parentSize.height*(1.25/3.0))
    }
  }
